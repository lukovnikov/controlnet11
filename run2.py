...
def main(device=3, simulate=False):
    expdirs = [
        ...
        # "/USERSPACE/lukovdg1/controlnet11/checkpoints/v5/checkpoints_coco_posattn_v5_exp_1",
        "/USERSPACE/lukovdg1/controlnet11/checkpoints/v5/checkpoints_coco_posattn_v5_exp_2",
        # "/USERSPACE/lukovdg1/controlnet11/checkpoints/v5/checkpoints_coco_posattn_v5_exp_3",
        # "/USERSPACE/lukovdg1/controlnet11/checkpoints/v5/checkpoints_coco_posattn_v5_exp_4",
        # "/USERSPACE/lukovdg1/controlnet11/checkpoints/v5/checkpoints_coco_posattn_v5_exp_5",
