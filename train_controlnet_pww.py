...
def main(batsize=5,
        ...
        #  loadckpt="",
         loadckpt="/USERSPACE/lukovdg1/controlnet11/checkpoints/pretrain-v6/checkpoints_coco_controlnetmod_hint_exp_1_forreal/interval_delta_epoch=epoch=4_step=step=50086.ckpt",
